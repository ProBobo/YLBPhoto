...
#import "YULIBONavigationBarView.h"
#import <YLBCommon/YLBCommon.h>

@implementation YULIBONavigationBarView

+ (instancetype)createView {
    YULIBONavigationBarView *bar = [[YULIBONavigationBarView alloc] init];
